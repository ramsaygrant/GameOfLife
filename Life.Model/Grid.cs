...
namespace Life.Model
{
    public class Grid
    {
        ...
        /// <summary>
        /// Indexer to get grid cell using indexes for ease of use
        /// </summary>
        /// <param name="x"></param>
        /// <param name="y"></param>
        ...
        public Cell this[int x, int y]
        {
            get
            {
                if (GridObj.Count <= x || ColumnCount <= y) throw new ArgumentOutOfRangeException("Argument out of bound");
        ...
        /// <summary>
        /// Indexer to get grid row using index for ease of use
        /// </summary>
        /// <param name="x"></param>
        ...
        {
            if (index < 0 || index >= RowCount) throw new ArgumentOutOfRangeException(
                "Invalid Index value: must be greater than or equal to zero and less than Row count");
